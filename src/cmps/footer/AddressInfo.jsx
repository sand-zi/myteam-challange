...
export function AddressInfo() {
    return (
        <div className="address-info">
            <div className="address-info-layout main-layout">
                <div className="content-container flex">
                    <div className="brand-container flex column justify-space-between">
                        <div className="logo">
                            <img src={"./images/logo.svg"} alt="logo" />
                        </div>
                        <nav>
                            <ul className="main-nav clean-list flex justify-space-between">
                    ...
                    <div className="address-container">
                        <p className='small'>987  Hillcrest Lane</p>
                        <p className='small'>Irvine, CA</p>
                        <p className='small'>California 92714</p>
                        <p className='small'>Call Us : 949-833-7432</p>
                    </div>
                    <div className="outer-info-container flex column justify-space-between">
                        ...
                        <div className="copyrights-container">
                            <p className='small'>Copyright 2020. All Rights Reserved</p>
